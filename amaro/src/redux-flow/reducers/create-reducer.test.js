...
it('createReducer(initialState, {}) should return a function reducer', () => {
  expect(createReducer([], {})).to.be.a('function')
})
...
it('reduce should return latest state if action is unknown', () => {
  const before = 3
...
it('reducer should return initialState when state before is undefined', () => {
